...
public class ModBlockLootProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        // ---- Molten Age blocks ----
        this.dropSelf(ModBlocks.MOLTEN_STEEL_BLOCK);
        this.dropSelf(ModBlocks.CHARRED_BRICKS);
        this.dropSelf(ModBlocks.MOLTEN_STEEL_CHAIN);
        this.dropSelf(ModBlocks.MOLTEN_LANTERN);
        this.dropSelf(ModBlocks.MOLTEN_ALTAR);
        // Molten glass drops only when mined with Silk Touch (like vanilla glass).
        this.dropWhenSilkTouch(ModBlocks.MOLTEN_GLASS);
    }
}
