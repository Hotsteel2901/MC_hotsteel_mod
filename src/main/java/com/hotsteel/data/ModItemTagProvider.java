...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        // =====================================================================
        //  Molten Age equipment
        // =====================================================================

        // Tool type tags
        this.tag(ItemTags.SWORDS)
            .add(k(ModItems.MOLTEN_STEEL_SWORD)).add(k(ModItems.MOLTEN_STEEL_SCYTHE));
        this.tag(ItemTags.PICKAXES).add(k(ModItems.MOLTEN_STEEL_PICKAXE));
        this.tag(ItemTags.AXES).add(k(ModItems.MOLTEN_STEEL_AXE));
        this.tag(ItemTags.SHOVELS).add(k(ModItems.MOLTEN_STEEL_SHOVEL));
        this.tag(ItemTags.HOES).add(k(ModItems.MOLTEN_STEEL_HOE));
        ...
        this.tag(ItemTags.SHARP_WEAPON_ENCHANTABLE)
            .add(k(ModItems.MOLTEN_STEEL_SWORD)).add(k(ModItems.MOLTEN_STEEL_SCYTHE))
            .add(k(ModItems.MOLTEN_STEEL_AXE));
        this.tag(ItemTags.WEAPON_ENCHANTABLE)
            .add(k(ModItems.MOLTEN_STEEL_SWORD)).add(k(ModItems.MOLTEN_STEEL_SCYTHE))
            .add(k(ModItems.MOLTEN_STEEL_AXE));
        ...
        // Mining enchantability
        this.tag(ItemTags.MINING_ENCHANTABLE)
            .add(k(ModItems.MOLTEN_STEEL_PICKAXE)).add(k(ModItems.MOLTEN_STEEL_AXE))
            .add(k(ModItems.MOLTEN_STEEL_SHOVEL)).add(k(ModItems.MOLTEN_STEEL_HOE));
        this.tag(ItemTags.MINING_LOOT_ENCHANTABLE)
            .add(k(ModItems.MOLTEN_STEEL_PICKAXE)).add(k(ModItems.MOLTEN_STEEL_AXE))
            .add(k(ModItems.MOLTEN_STEEL_SHOVEL)).add(k(ModItems.MOLTEN_STEEL_HOE));
        ...
        // Armor
        this.tag(ItemTags.ARMOR_ENCHANTABLE)
            .add(k(ModItems.MOLTEN_STEEL_HELMET)).add(k(ModItems.MOLTEN_STEEL_CHESTPLATE))
            .add(k(ModItems.MOLTEN_STEEL_LEGGINGS)).add(k(ModItems.MOLTEN_STEEL_BOOTS));
        this.tag(ItemTags.EQUIPPABLE_ENCHANTABLE)
            .add(k(ModItems.MOLTEN_STEEL_HELMET)).add(k(ModItems.MOLTEN_STEEL_CHESTPLATE))
            .add(k(ModItems.MOLTEN_STEEL_LEGGINGS)).add(k(ModItems.MOLTEN_STEEL_BOOTS));
        this.tag(ItemTags.HEAD_ARMOR_ENCHANTABLE).add(k(ModItems.MOLTEN_STEEL_HELMET));
        this.tag(ItemTags.CHEST_ARMOR_ENCHANTABLE).add(k(ModItems.MOLTEN_STEEL_CHESTPLATE));
        this.tag(ItemTags.LEG_ARMOR_ENCHANTABLE).add(k(ModItems.MOLTEN_STEEL_LEGGINGS));
        this.tag(ItemTags.FOOT_ARMOR_ENCHANTABLE).add(k(ModItems.MOLTEN_STEEL_BOOTS));
