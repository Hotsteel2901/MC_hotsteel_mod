...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ...
        // 4 molten shards -> 1 molten core
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.MOLTEN_CORE)
            .requires(ModItems.MOLTEN_SHARD, 4)
            .unlockedBy("has_molten_shard", has(ModItems.MOLTEN_SHARD)).save(exporter);

        // 4 hot steel ingots + 1 molten core -> 2 molten steel ingots
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOLTEN_STEEL_INGOT, 2)
            .pattern(" H ").pattern("HCH").pattern(" H ")
            .define('H', ModItems.HOT_STEEL_INGOT).define('C', ModItems.MOLTEN_CORE)
            .unlockedBy("has_molten_core", has(ModItems.MOLTEN_CORE)).save(exporter);

        // 9 molten steel nuggets <-> molten steel ingot
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOLTEN_STEEL_INGOT)
            .pattern("NNN").pattern("NNN").pattern("NNN")
            .define('N', ModItems.MOLTEN_STEEL_NUGGET)
            .unlockedBy("has_molten_steel_nugget", has(ModItems.MOLTEN_STEEL_NUGGET))
            .save(exporter, "molten_steel_ingot_from_nugget");
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.MOLTEN_STEEL_NUGGET, 9)
            .requires(ModItems.MOLTEN_STEEL_INGOT)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);

        // 9 molten steel ingots <-> molten steel block
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOLTEN_STEEL_BLOCK)
            .pattern("III").pattern("III").pattern("III")
            .define('I', ModItems.MOLTEN_STEEL_INGOT)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.MOLTEN_STEEL_INGOT, 9)
            .requires(ModBlocks.MOLTEN_STEEL_BLOCK)
            .unlockedBy("has_molten_steel_block", has(ModBlocks.MOLTEN_STEEL_BLOCK))
            .save(exporter, "molten_steel_ingot_from_block");

        // ---- Molten-forged armor (vanilla patterns) ----
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.MOLTEN_STEEL_HELMET)
            .pattern("III").pattern("I I")
            .define('I', ModItems.MOLTEN_STEEL_INGOT)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.MOLTEN_STEEL_CHESTPLATE)
            .pattern("I I").pattern("III").pattern("III")
            .define('I', ModItems.MOLTEN_STEEL_INGOT)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.MOLTEN_STEEL_LEGGINGS)
            .pattern("III").pattern("I I").pattern("I I")
            .define('I', ModItems.MOLTEN_STEEL_INGOT)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.MOLTEN_STEEL_BOOTS)
            .pattern("I I").pattern("I I")
            .define('I', ModItems.MOLTEN_STEEL_INGOT)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);

        // ---- Molten-forged tools & weapons (vanilla patterns) ----
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.MOLTEN_STEEL_SWORD)
            .pattern("I").pattern("I").pattern("S")
            .define('I', ModItems.MOLTEN_STEEL_INGOT).define('S', Items.STICK)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.MOLTEN_STEEL_PICKAXE)
            .pattern("III").pattern(" S ").pattern(" S ")
            .define('I', ModItems.MOLTEN_STEEL_INGOT).define('S', Items.STICK)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.MOLTEN_STEEL_AXE)
            .pattern("II").pattern("IS").pattern(" S")
            .define('I', ModItems.MOLTEN_STEEL_INGOT).define('S', Items.STICK)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.MOLTEN_STEEL_SHOVEL)
            .pattern("I").pattern("S").pattern("S")
            .define('I', ModItems.MOLTEN_STEEL_INGOT).define('S', Items.STICK)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.MOLTEN_STEEL_HOE)
            .pattern("II").pattern(" S").pattern(" S")
            .define('I', ModItems.MOLTEN_STEEL_INGOT).define('S', Items.STICK)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);

        // ---- Molten-forged scythe (blade on a curved haft) ----
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.MOLTEN_STEEL_SCYTHE)
            .pattern("III").pattern("  S").pattern(" S ")
            .define('I', ModItems.MOLTEN_STEEL_INGOT).define('S', Items.STICK)
            .unlockedBy("has_molten_steel_ingot", has(ModItems.MOLTEN_STEEL_INGOT)).save(exporter);

        // ---- Molten glass (furnace / blast furnace) ----
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.GLASS),
                RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOLTEN_GLASS, 0.3f, 200)
            .unlockedBy("has_glass", has(Items.GLASS))
            .save(exporter);
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Items.GLASS),
                RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOLTEN_GLASS, 0.3f, 100)
            .unlockedBy("has_glass", has(Items.GLASS))
            .save(exporter, "molten_glass_from_blasting");

        // ---- Charred bricks (blast furnace) ----
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Items.DEEPSLATE_BRICKS),
                RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHARRED_BRICKS, 0.3f, 100)
            .unlockedBy("has_deepslate_bricks", has(Items.DEEPSLATE_BRICKS))
            .save(exporter, "charred_bricks_from_blasting");

        // ---- Molten steel chain ----
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOLTEN_STEEL_CHAIN, 6)
            .pattern("N N").pattern("N N").pattern("N N")
            .define('N', ModItems.MOLTEN_STEEL_NUGGET)
            .unlockedBy("has_molten_steel_nugget", has(ModItems.MOLTEN_STEEL_NUGGET)).save(exporter);

        // ---- Molten lantern ----
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.MOLTEN_LANTERN)
            .pattern("NNN").pattern("NTN").pattern("NNN")
            .define('N', ModItems.MOLTEN_STEEL_NUGGET).define('T', Items.TORCH)
            .unlockedBy("has_molten_steel_nugget", has(ModItems.MOLTEN_STEEL_NUGGET)).save(exporter);

        // ---- Hot steel codex ----
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.HOT_STEEL_CODEX)
            .requires(Items.BOOK)
            .requires(ModItems.HOT_STEEL_INGOT)
            .requires(ModItems.MOLTEN_SHARD)
            .unlockedBy("has_hot_steel_ingot", has(ModItems.HOT_STEEL_INGOT)).save(exporter);
    }
}
